...
const MissionVision: React.FC = () => {
  ...
  const impactStats = [
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-12 w-12 text-yellow-600" />,
    },
    {
      id: 4,
      number: "40+",
  ...
  return (
    <div className="bg-gray-50">
      {/* Hero Banner */}
      <section className="relative bg-gradient-to-r from-yellow-700 to-yellow-700 py-20 px-6">
      ...
      {/* Our Impact Section */}
      <section className="py-16 px-6 bg-yellow-600">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {impactStats.map((stat) => (
              ...
              >
                ...
                <h4 className="text-xl font-semibold mb-3 text-yellow-600">{stat.title}</h4>
          ...
          <div className="mt-12 bg-white p-8 rounded-lg shadow-lg">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <Link to="/impact-stories" className="inline-flex items-center bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-6 rounded-md transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/volunteer" className="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-6 rounded-md text-center transition-colors duration-300">
                    Volunteer With Us
                  </Link>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col md:flex-row gap-4">
              <input 
                ...
                className="px-4 py-3 rounded-md flex-grow text-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-600" 
              />
              <button type="submit" className="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-6 rounded-md transition-colors duration-300">
                Subscribe
              </button>
            </form>
